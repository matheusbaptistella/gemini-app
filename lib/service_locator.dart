...
import 'package:gemini_app/data/repository/story/story_repository.dart';
...
Future<void> initializeDependencies() async {
  ...
  sl.registerSingleton<StoryGeminiService>(StoryGeminiServiceImpl());

  sl.registerSingleton<StoryRepository>(StoryRepostitoryImpl());

  sl.registerSingleton<CreateStoryUseCase>(CreateStoryUseCase());

  sl.registerSingleton<ParseStoryUseCase>(ParseStoryUseCase());
}
